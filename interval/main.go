...
func (i *Instances) readFromZones(i, sensorid string) string{

	address,stuff, err := i.Consul.Catalog.Service("sensorlocation")
	resp, err := http.Get(address[0]+"/sensor/"+sensorid)
	if err != nil {
